...
public class FlinkSink {
     ...
     * table. We use {@link RowData} inside the org.apache.iceberg.flink.sink connector, so users need to provide a mapper
     ...
     * iceberg table. We use {@link RowData} inside the org.apache.iceberg.flink.sink connector, so users need to provide a
    ...
    public static class Builder {
        ...
        /**
         * Set the write properties for Flink org.apache.iceberg.flink.sink. View the supported properties in {@link
         * FlinkWriteOptions}
         */
        ...
        /**
         * Configure the write {@link DistributionMode} that the flink org.apache.iceberg.flink.sink will use. Currently, flink
         ...
         * multiple operators (like writer, committer, dummy org.apache.iceberg.flink.sink etc.) Actually operator uid will be
         ...
         * checkpoint, Flink won't be able to restore the previous Flink org.apache.iceberg.flink.sink operator state (more
         * specifically the committer operator state). You need to use {@code --allowNonRestoredState}
         * to ignore the previous org.apache.iceberg.flink.sink state. During restore Flink org.apache.iceberg.flink.sink state is used to check if last
         ...
         *
         * @param newPrefix prefix for Flink org.apache.iceberg.flink.sink operator uid and name
         * @return {@link Builder} to connect the iceberg table.
         */
        ...
        /**
         * Append the iceberg org.apache.iceberg.flink.sink operators to write records to iceberg table.
         *
         * @return {@link DataStreamSink} for org.apache.iceberg.flink.sink.
         */
