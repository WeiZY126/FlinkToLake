...
import com.crm.function.jsonParserProcess_m;
...
public class KafkaToIcebergMain_m {
    public static void main(String[] args) throws Exception {
        InputStream propertiesInputStream = KafkaToIcebergMain_m.class.getResourceAsStream("/config.properties");
        ...
        configuration.addResource(KafkaToIcebergMain_m.class.getResourceAsStream("/core-site.xml"));
        configuration.addResource(KafkaToIcebergMain_m.class.getResourceAsStream("/hdfs-site.xml"));
        configuration.addResource(KafkaToIcebergMain_m.class.getResourceAsStream("/hive-site.xml"));
        ...
        tableMapperBeanList.forEach(System.out::println);
        SingleOutputStreamOperator parseStream = new SideOutPutBuilder(tableMapperBeanList, kafkaSourceStream, catalogLoader, parameterTool)
                .parse(new jsonParserProcess_m(tableMapperBeanList, parameterTool.get("iceberg.namespace.name"), catalogLoader));
    ...
    private static List<TableMapperBean> analyzeTableMapper() throws Exception {
        InputStream tableMapperInputStream = KafkaToIcebergMain_m.class.getResourceAsStream("/tableMapper_m");
